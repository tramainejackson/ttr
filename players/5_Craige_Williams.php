...
function display_func($player)
{
	...
	{							
		...
		echo "</div><div data-role='footer' data-theme='b' data-position='fixed'><h1>Footer Text</h1></div></div>";
	}
}
?>
<!DOCTYPE html>
...
<body>
<div data-role='page' class='player_display'>
<?php include ($_SERVER['DOCUMENT_ROOT']. '/mobile/m.panel.php'); ?>
<div data-role="header" data-theme="b" data-position="fixed">
	<h1>Player Profile</h1>
	<a href="#menu_panel" class="ui-btn">Menu</a>
</div>
<?php
$player_name = "Retrokid1988";
