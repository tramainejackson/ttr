...
function display_func($leagues)
{
	...
	$row_cnt = mysqli_num_rows($results3);
			while($row3 = mysqli_fetch_assoc($results3))
			{
				...
				{
					echo "<tr><td id='leagues_site_td'><button class='leagues_site_btn'><a href='/leagues/".$row3['leagues_name']."/'>Continue to leagues site</a></button></td></tr>";	
				}
...
<script src="/scripts/totherec_leagues.js"></script>
</body>
</html>